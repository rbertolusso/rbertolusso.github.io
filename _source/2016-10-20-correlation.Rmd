...
```{r, echo=c(1:4), fig.width=6, fig.height=6.5, fig.align='center'}
...
```{r, echo=-(1:4), fig.width=6, fig.height=6.5, fig.align='center'}
plot(x, y,
     xlim = c(58, 80), ylim = c(58, 80),
     xaxt = "n", yaxt = "n", xaxs = "i", yaxs = "i",
     main = "Pearson's data",
...
```{r, echo=-(1:6), fig.width=6, fig.height=6.5, fig.align='center'}
plot(x, y,
     xlim = c(58, 80), ylim = c(58, 80),
     xaxt = "n", yaxt = "n", xaxs = "i", yaxs = "i",
     main = "Pearson's data",
...
```{r, echo=FALSE, fig.width=8, fig.height=2.67, fig.align='center'}
set.seed(123)
...
```{r, echo=FALSE, fig.width=6, fig.height=6.5, fig.align='center'}
plot(x, y,
     xlim = c(58, 80), ylim = c(58, 80),
     xaxt = "n", yaxt = "n", xaxs = "i", yaxs = "i",
     main = "Pearson's data",
...
```{r, echo=1, fig.width=6, fig.height=6.5, fig.align='center'}
